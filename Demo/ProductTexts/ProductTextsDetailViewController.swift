//
// ProductTextsDetailViewController.swift
// Demo
//
...
class ProductTextsDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "ProductTextsMasterViewControllerLogger")
    ...
    func createEntityWithDefaultValues() -> ProductText {
        ...
        newEntity.id = CellCreationHelper.defaultValueFor(ProductText.id)
...
extension ProductTextsDetailViewController: EntityUpdaterDelegate {
