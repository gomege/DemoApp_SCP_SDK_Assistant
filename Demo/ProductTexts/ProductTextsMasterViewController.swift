//
// ProductTextsMasterViewController.swift
// Demo
//
...
class ProductTextsMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "ProductTextMasterViewConterollerLogger")
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.espmContainer.fetchProductTexts(matching: query) { productTexts, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ProductTextsDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! ProductTextsDetailViewController
...
extension ProductTextsMasterViewController: EntitySetUpdaterDelegate {
