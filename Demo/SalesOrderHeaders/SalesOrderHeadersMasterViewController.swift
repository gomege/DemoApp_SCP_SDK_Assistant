...
class SalesOrderHeadersMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "SalesOrderHeaderMasterViewConterollerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! SalesOrderHeadersDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! SalesOrderHeadersDetailViewController
...
extension SalesOrderHeadersMasterViewController: EntitySetUpdaterDelegate {
