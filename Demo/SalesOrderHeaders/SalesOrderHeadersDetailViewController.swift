//
// SalesOrderHeadersDetailViewController.swift
// Demo
//
...
class SalesOrderHeadersDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "SalesOrderHeadersMasterViewControllerLogger")
...
extension SalesOrderHeadersDetailViewController: EntityUpdaterDelegate {
