//
// PurchaseOrderHeadersMasterViewController.swift
// Demo
//
...
class PurchaseOrderHeadersMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "PurchaseOrderHeaderMasterViewConterollerLogger")
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.espmContainer.fetchPurchaseOrderHeaders(matching: query) { purchaseOrderHeaders, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! PurchaseOrderHeadersDetailViewController
...
extension PurchaseOrderHeadersMasterViewController: EntitySetUpdaterDelegate {
