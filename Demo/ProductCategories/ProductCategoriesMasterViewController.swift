//
// ProductCategoriesMasterViewController.swift
// Demo
//
...
class ProductCategoriesMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "ProductCategoryMasterViewConterollerLogger")
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.espmContainer.fetchProductCategories(matching: query) { productCategories, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ProductCategoriesDetailViewController
            ...
            let detailViewController = dest.viewControllers[0] as! ProductCategoriesDetailViewController
...
extension ProductCategoriesMasterViewController: EntitySetUpdaterDelegate {
