//
// SalesOrderItemsMasterViewController.swift
// Demo
//
...
class SalesOrderItemsMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "SalesOrderItemMasterViewConterollerLogger")
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.espmContainer.fetchSalesOrderItems(matching: query) { salesOrderItems, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! SalesOrderItemsDetailViewController
...
extension SalesOrderItemsMasterViewController: EntitySetUpdaterDelegate {
