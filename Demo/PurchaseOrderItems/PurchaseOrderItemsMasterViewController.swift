//
// PurchaseOrderItemsMasterViewController.swift
// Demo
//
...
class PurchaseOrderItemsMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "PurchaseOrderItemMasterViewConterollerLogger")
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.espmContainer.fetchPurchaseOrderItems(matching: query) { purchaseOrderItems, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! PurchaseOrderItemsDetailViewController
...
extension PurchaseOrderItemsMasterViewController: EntitySetUpdaterDelegate {
